...
public abstract class EntityAITargetSFA extends EntityAIBase
{
    ...
    protected boolean isSuitableTarget(EntityLivingBase p_75296_1_, boolean p_75296_2_)
    {
        ...
        else
        {
            ...
            if ( this.taskOwner instanceof EntityCreature && !((EntityCreature) this.taskOwner).isWithinHomeDistance(MathHelper.floor_double(p_75296_1_.posX), MathHelper.floor_double(p_75296_1_.posY), MathHelper.floor_double(p_75296_1_.posZ)))
            {
                return false;
            }
