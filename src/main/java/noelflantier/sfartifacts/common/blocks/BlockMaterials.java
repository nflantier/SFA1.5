...
public class BlockMaterials extends BlockSFA{
	...
	public BlockMaterials(Material material, String name) {
		super(material, name);
	}
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitx, float hity, float hitz){
		...
		int mode = ItemNBTHelper.getInteger(player.getCurrentEquippedItem(), "Mode", 1);
